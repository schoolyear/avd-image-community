...
Office. By doing this, it avoids a complete Office installation. The layer additionally also allows a user to (optionally) select a different language than en-US for the Office apps. Also optionally, the layer removes a Privacy first-run pop-up.
